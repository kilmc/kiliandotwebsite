...
<main>
	<div class="flex m-10 mb-20 md:m-20 items-center">
		<a
			href="/"
			class="inline-block font-bold uppercase dark:text-emerald-500 text-blue-600 hover:bg-slate-200 text-lg"
		>
			Kilian Dot Website
		</a>

		<button aria-pressed={concise} on:click={() => (concise = !concise)} class="ml-auto">
			<div class="flex gap-3">
				<div
					class="rounded-full border border-black/50 dark:border-white p-1 w-12 flex {concise
						? 'bg-black dark:bg-white justify-end'
						: 'bg-white dark:bg-black justify-start'}"
				>
					<span
						class="{concise
							? 'bg-white dark:bg-black'
							: 'bg-black dark:bg-white'} rounded-full block w-4 h-4"
					/>
				</div>
				<span class="font-bold">Concise</span>
			</div>
		</button>
	</div>
	{#if concise}
		<div class="px-10 md:px-20 text-3xl md:text-4xl max-w-4xl">
			<p class="mb-10">Nice to meet you, my name's Kilian.</p>
			<p class="leading-snug mb-10">
				I'm experienced, hard-working and good at what I do. I'm looking for work because I need to
				pay my bills. Design, engineering and creative problem solving are my strengths. Beyond that
				I'm a diligent learner, detail-oriented and I like being challenged.
			</p>
			<a
	...
	{:else}
		<div>
			<div class="grid grid-cols-1 md:grid-cols-3 gap-10 p-10 pt-0 md:mb-20 md:p-20">
				<div class="col-span-1 md:col-span-2 max-w-xl">
					<div class="text-4xl font-bold">Kilian McMahon</div>
					<div class="text-4xl mb-8">Freelance Designer <br />& Engineer</div>

					<p class="text-2xl mb-8">
						I've worked on the web since 2011 doing a wide variety of jobs across design and
						engineering. I've also worked in print, art directed in-person events and done quirky
						side projects with a focus on the small details that make for a magical experience for
						the audience, attendees, or users.
					</p>

					<p class="text-2xl">
						Read on to get more detail about the jobs I've done and my skillset, but if I already
						seem like a good fit for a project of yours, feel free to&nbsp;<a
							href="mailto:mail@kilian.website"
							class="bg-black text-white dark:bg-emerald-950 py-0.5 px-2 inline-block rounded-md hover:bg-zinc-300 hover:text-black"
						>
							reach out
			...
			<div
				class="p-10 md:p-20 md:pb-36 bg-gradient-to-t to-white from-emerald-100 dark:to-black dark:from-green-950"
			>
				<h2 class="text-4xl mb-8">Work</h2>
				<div class="grid grid-cols-1 md:grid-cols-2 gap-20">
					<div>
						<h2 class="text-2xl mb-8">Jobs</h2>
						<div>
							{#each data.jobs as [company, jobs]}
								<div class="mb-10">
									<div class="flex mb-3">
									...
									<div>
										{#each jobs as job}
											<a
												href={job.url}
												class="bg-white/50 hover:bg-white dark:bg-black/30 dark:hover:bg-black p-4 shadow-md rounded-md block mb-4"
											>
												{#if job.title}<div class="font-bold">{job.title}</div>{/if}
					...
					<div class="@container">
						<h2 class="text-2xl mb-8">Side Projects</h2>
						<div class="grid grid-cols-1 @4xl:grid-cols-2 gap-10">
							<ul class="grid gap-4 grid-cols-1">
								{#each data.items as project}
									<li class="rounded-lg overflow-clip shadow-md">
										<a
											href={project.url}
											class="bg-white/50 hover:bg-white dark:bg-black/30 dark:hover:bg-black w-full h-full grid grid-cols-[5rem_1fr] gap-5"
										>
											<div
												class="aspect-2/3 flex font-bold uppercase text-center bg-cover"
												style="background-image: url('{project.poster}');"
											/>

											<div class="py-5 pr-5">
												<div class="font-bold mb-2 line-clamp-1">{project.text}</div>
			...
			>
				...
				<div class="grid grid-cols-1 lg:grid-cols-2">
					<p class="mb-16">
						I've worked across disciplines for a long time and have gathered skills, experience and
						a proficiency with myriad tools along the way. I'm very comfortable adapting to new
			...
			<div class="max-w-2xl p-10 md:p-20 pb-0">
				...
				<p class="text-xl leading-8">
					I never want to undermine a Union's power. I have first-hand experience organising and
					being part of a union—shout out to <a class="link" href="https://kickstarterunited.org"
					...
					at the expense of Workers and their collective power. If I am working for your employer
					and you feel that my presence is making it harder for you to organise or bargain, please
					contact me and I will do what I can to end my contract as soon as possible. Solidarity
					forever.
				</p>
			</div>
		</div>
